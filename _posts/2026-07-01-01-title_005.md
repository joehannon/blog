---
title: "5: Mathematical details of this implementation of the Baldyga closure"
date: 2026-07-01
layout: post
mathjax: true
---

**I refer to this method as "blend\_fs" in species_limits.py**
...
In each term of the sum, $c^{fs}_{ki}/(1 - f_{sk})$ is the stoichiometric yield of
...
The full species profile interpolates between limit and no-reaction:

$$C_i(f) = \lambda_i\,M_i(f) + (1 - \lambda_i)\,B_i(f)$$

$\lambda_i$ is chosen so that the Beta-weighted mean matches the ODE value $y_i$:

$$\lambda_i = \frac{\mathbb{E}[B_i] - y_i}{\mathbb{E}[B_i] - \mathbb{E}[M_i]}, \qquad \lambda_i \in [0, 1]$$
