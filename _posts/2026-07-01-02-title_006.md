...
I did not make it very easy in species_limits.py to compare different flavours of blend_fs on one plot.  I will probably do that later.
...
With this particular selection of subsets (20, 27, 29), XQ rises slower and then a little more more sharply than it did using subsets 20 and 31.  It is possible that with another basis for limit selection, results would be nearer to the results using subsets 20 and 31.
