...
With this particular selection of subsets (20, 27, 29), XQ rises slower and then a little more sharply than it did using subsets 20 and 31.  It is possible that with another basis for limit selection, results would be nearer to the results using subsets 20 and 31.
