...
Results of an ODE solve, using blend_fs to automatically blend three limits (20, 27, 29) that are each one short of a product, compared to base case Blend_fs using subsets 20, 31 [full-size](/blog/docs/assets/compare_blends_fuller_BC_azo_coupling_kinetics_eps1_ode.png):

![ODE solve using blend_fs and three one-short limits](/blog/docs/assets/compare_blends_fuller_BC_azo_coupling_kinetics_eps1_ode.png){: width="1000" }

Under these conditions, the reaction rate profiles are smooth and well-behaved.  Diagnostics generated during the solve continue to show significant clamping of the solution with subsets 20, 27, 29.

Results of the corresponding epsilon sweep [full-size](/blog/docs/assets/compare_blends_fuller_BC_azo_coupling_kinetics_Xspecies_vs_epsilon.png):

![Epsilon sweep using one-short subsets](/blog/docs/assets/compare_blends_fuller_BC_azo_coupling_kinetics_Xspecies_vs_epsilon.png){: width="1000" }

The fractional product curves such as XQ and XS with 20, 27, 29 are generally quite smooth and behave well at either end.
