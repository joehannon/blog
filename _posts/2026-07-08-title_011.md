...
In the case of the 5-reaction system we are using for illustration, the full scheme is: A+B>R, A+R>S, A+B>T, A+T>S, A+C>Q and denoting the extents as $\alpha$, $\beta$, $\gamma$, $\delta$ and $\epsilon$ respectively, a one-line compsote reaction extent summary based on the extents of the underlying reactions is: 
